...
class openCheckinAccount {
    ...
    async OpenAccount() {
        ...
        await this.accountType.selectOption('CHECKING')
        await expect(this.id).toBeVisible( )
        // await this.id.selectOption(data.accountId.toString())
        ...
        console.log("NEW checking Account Number: " + accNum)
        

    }       
}

export default openCheckinAccount